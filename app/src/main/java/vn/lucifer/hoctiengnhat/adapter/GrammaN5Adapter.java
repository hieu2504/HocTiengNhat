...
public class GrammaN5Adapter extends RecyclerView.Adapter<GrammaN5Adapter.MyViewHolder> {
    Context context;
    List<Gramma> grammaList;
    public GrammaN5Adapter(Context context, List<Gramma> grammaList){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GrammaN5Adapter.MyViewHolder(v);
    }
