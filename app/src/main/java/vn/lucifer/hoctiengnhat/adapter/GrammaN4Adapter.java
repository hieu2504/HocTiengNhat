...
public class GrammaN4Adapter extends RecyclerView.Adapter<GrammaN4Adapter.MyViewHolder> {

    Context context;
    List<Gramma> grammaList;
    public GrammaN4Adapter(Context context, List<Gramma> grammaList){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GrammaN4Adapter.MyViewHolder(v);
    }
